...
/*
 * 获取location中search的值 @return {string} value 返回userId
 * Added at 2016-12-28
 */
...
/*
 * 获取location中search的值 @return {String} value 返回envId
 * Added at 2016-12-28
 */
Util.param.getEnvId = function() {
    var ids = /envId=(\d+)&?/.exec(location.search);
    var id = ids ? ids[1] : '';
    return id;
}

/*
 * 获取location中search的值 @return {string} value 返回appId
 * Added at 2016-12-28
 */
Util.param.getAppId = function() {
    var ids = /appId=(\d+)&?/.exec(location.search);
    var id = ids ? ids[1] : '';
    return id;
}
