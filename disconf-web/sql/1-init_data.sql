...
VALUES
    ...
    (76, 2, '/api/user/list', '用户列表', '1000', '99991231235959');        
    (77, 2, '/api/user/modify', '新加用户', '0010', '99991231235959');      
    (78, 2, '/api/user/{userId}', '单个用户', '1101', '99991231235959');    
    (79, 2, '/api/app/{appId}', '单个app', '1101', '99991231235959');       
    (80, 2, '/api/env/{envId}', '单个env', '1101', '99991231235959');       
    (81, 2, '/api/role/list', '角色列表', '1000', '99991231235959');        
